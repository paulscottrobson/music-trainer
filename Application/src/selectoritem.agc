...
function SelectorItem_New(sli ref as SelectorItem,width as integer,height as integer,depth as integer,baseID as integer)
	...
	sli.depth = depth 
	sli.baseID = baseID
	CreateSprite(sli.baseID,IDFRAME)
...
function SelectorItem_IsClicked(sli ref as SelectorItem,ci as ClickInfo)
	isHit = GetSpriteHitTest(sli.baseID,ci.x,ci.y)
endfunction isHit
